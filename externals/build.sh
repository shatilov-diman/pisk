...
export ANDROID_TOOLCHAIN=arm-linux-androideabi-5
...
export COMMON_BUILD_ROOT=${EXTERNAL_ROOT}/sources${TAG}
...
export INSTALL_DIR=${INSTALL_ROOT}/prebuilt${TAG}/${ANDROID_PLATFORM}/${ANDROID_ARCH}
