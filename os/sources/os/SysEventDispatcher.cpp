...
SafeComponentPtr __cdecl syseventdispatcher_factory(const ServiceRegistry&, const InstanceFactory& factory, const pisk::utils::property&)
{
	...
	return factory.make<pisk::os::OSSysEventDispatcher>();
}
