...
set (CMAKE_PREFIX_PATH ${JSONCPP_ROOT_DIR})
FIND_LIBRARY (JSONCPP_LIBRARY_RELEASE NAMES jsoncpp lib_json PATH_SUFFIXES Release
 DOC "jsoncpp release library")

set (CMAKE_PREFIX_PATH ${JSONCPP_ROOT_DIR})
FIND_LIBRARY (JSONCPP_LIBRARY_DEBUG NAMES jsoncpp lib_json PATH_SUFFIXES Debug
 DOC "jsoncpp release library")
...
IF (JSONCPP_INCLUDE_DIR)
 ...
 ".*JSONCPP_VERSION_STRING[ \t]+\"[0-9\\.]+\"")


 STRING (REGEX REPLACE
  ".*[ \t]+JSONCPP_VERSION_STRING[ \t]+\"([0-9\\.]*)\".*" "\\1"
...
MARK_AS_ADVANCED (JSONCPP_ROOT_DIR JSONCPP_INCLUDE_DIR JSONCPP_LIBRARY
 JSONCPP_LIBRARY_DEBUG JSONCPP_LIBRARY_RELEASE JSONCPP_LIBRARIES)
